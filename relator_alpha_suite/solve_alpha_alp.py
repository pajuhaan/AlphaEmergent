...
from relator_alpha.article_constants import (
    LAMBDA_GEOM_MEAN,
    SCALAR_MODEL_PRESETS,
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--width", type=int, default=200, help="Console width used for Rich tables.")
    return parser
...
def main() -> None:
    ...
    if args.branch == "article":
        ...
        dc_value = solve_dc_article(result.alpha, model).d_c
    ...
    alp_table.add_row("lock residual", format_mpf(result.residual, 12), result.note)
